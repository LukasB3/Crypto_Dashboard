...
btc = client.get_historical_klines('BTCUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# ETH
eth = client.get_historical_klines('ETHUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# BNB
bnb = client.get_historical_klines('BNBUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# ADA
ada = client.get_historical_klines('ADAUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# XRP
xrp = client.get_historical_klines('XRPUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# SOL
sol = client.get_historical_klines('SOLUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# DOT
dot = client.get_historical_klines('DOTUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# DOGE
doge = client.get_historical_klines('DOGEUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# TRX
trx = client.get_historical_klines('TRXUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
...
# AVAX
avax = client.get_historical_klines('AVAXUSDT', Client.KLINE_INTERVAL_1DAY, '1 Jan 2023')
